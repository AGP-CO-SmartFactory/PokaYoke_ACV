...
class EstadoPiezas:
    ...
    def __init__(self):
        ...
        WHERE 
            ...
            AND (DEFECTO = 'Resistencia fuera de tolerancia' OR DEFECTO = 'Borde paquete no uniforme' OR DEFECTO = 'MALLA F.T' OR DEFECTO = 'Burbujas En Paquete' OR DEFECTO = 'Burbuja' OR DEFECTO = 'PC Expuesto' OR DEFECTO = 'Mal posicionamiento de terminales')
